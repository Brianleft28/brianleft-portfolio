...
### Integraciones
- APIs REST/GraphQL
- Comunicación directa con Hardware (Raw Printing, ZPL, ESC-POS)
...
4. **POS API & Sistema de Kioscos** (Roadmap)
   - Arquitectura API-First para desacoplar lógica de cobro de interfaces
   - Customer Display independiente vía WebSockets
   - Pregunta: "háblame del POS" o "qué es el proyecto de kioscos"
